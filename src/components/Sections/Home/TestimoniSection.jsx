...
const TestimoniSection = () => {
  return (
    <SectionLayout classname="flex flex-col justify-center items-center gap-8 lg:gap-16 xl:gap-20 overflow-x-hidden">
      <SectionTitle title={"Testimoni Pelanggan"} classname={`self-start`} />
      <div className="relative flex flex-col lg:flex-row justify-center items-center gap-8 py-16">
