  ...
  return (
    ...
    >
      <section className="flex flex-col justify-center items-center md:items-start md:w-[50%] lg:pt-[60px] lg:pb-24 xl:pb-32 xl:pt-[100px]">
        <h1
          className={`text-2xl px-4 md:px-0 md:text-4xl lg:text-[36px] text-center  md:md:text-start  lg:leading-none font-bold font-playfair text-primary w-[175px]  border border-black md:md:w-full xl:w-[514px] md:pr-20 lg:pr-0`}
        >
        ...
        {/* SOSMED */}
        <div className="grid grid-cols-2 place-items-center gap-3 px-8 w-full mt-8 hp375:px-10 
        md:px-0 md:place-items-start md:pe-14 border border-black">
          <div className="flex items-center gap-2 w-[110px] border border-black">
      ...
      <section className="grid grid-cols-2 items-end mt-6 md:w-[50%] lg:w-[45%] lg:pb-24 xl:pb-32 border border-black">
