...
const QuotesSection = () => {
  return (
    <SectionLayout classname="relative h-[246px] md:h-[196px] lg:h-[263px] xl:h-[344px] flex items-center justify-center md:block bg-cover bg-center">
      ...
      <div className="relative z-10 flex flex-col items-center md:items-start justify-center max-w-2xl text-center md:text-left px-4 md:pl-2 lg:pl-4 gap-4 md:gap-2 lg:gap-5">
        ...
        <button className="mt-4 px-7 py-2 bg-[#193446] text-white text-sm md:text-base lg:text-lg rounded-[10px] shadow-md">Beli Produk</button>
      </div>
    </SectionLayout>
  );
};
